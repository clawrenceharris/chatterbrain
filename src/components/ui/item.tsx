...
const itemVariants = cva(
  "group/item flex w-full shadow-xs flex-wrap bg-card items-center rounded-2xl border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted",
  {
    variants: {
      variant: {
        default: "border-transparent",
        outline: "border-border/80 border-[1.8px]",
        muted: "border-transparent bg-muted",
      },
      size: {
        default: "gap-3.5 px-6 md:px-7 py-5",
