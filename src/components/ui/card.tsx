...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card bg-card text-card-foreground border-border/55 flex flex-col gap-6 overflow-hidden rounded-xl border-2 py-6 text-sm duration-300 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-4xl *:[img:last-child]:rounded-b-4xl",
        className,
      )}
      {...props}
    />
